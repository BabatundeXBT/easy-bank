...
function Footer() {
  return (
    <div className=" bg-[#2d314d] text-[#9698a5]">
      <div className=" flex items-center justify-center flex-col gap-5 text-white text-center md:flex-row md:justify-between md:w-[80%] m-auto">
        <div className="mt-10 md:flex items-center md:justify-evenly md:space-x-48 md:mt-5 md:text-left">
          <div>
